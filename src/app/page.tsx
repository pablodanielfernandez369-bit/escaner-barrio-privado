        ...
        <div className="flex flex-col justify-center text-center md:text-left space-y-10">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-3 p-2 bg-white luxury-card px-4 py-2 rounded-2xl w-fit self-center md:self-start">
               ...
               <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#064e3b]">Security System v3.5</span>
            </div>
                        <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-[#064e3b] leading-[0.85] italic">
                          Santa <br/>
                          <span className="text-[#10b981] not-italic">Ines</span>
                        </h1>
                      </div>
                      ...
                      <Link href="/login">
                        <motion.div whileHover={{ y: -5 }} whileTap={{ scale: 0.98 }} className="bg-white luxury-card p-10 rounded-[3rem] flex items-center justify-between group cursor-pointer transition-all border border-emerald-50/50 shadow-2xl">
                          <div className="flex items-center gap-8">
                            ...
                            <div>
                              <h3 className="text-xl font-black uppercase text-[#064e3b] tracking-tighter leading-none mb-2 italic">Terminal Guardia</h3>
                              <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]">Escaner de Rostro y DNI</p>
                            </div>
                          </div>
                      ...
                      <Link href="/login">
                        <motion.div whileHover={{ y: -5 }} whileTap={{ scale: 0.98 }} className="bg-white luxury-card p-10 rounded-[3rem] flex items-center justify-between group cursor-pointer transition-all border border-emerald-50/50 shadow-2xl">
                          <div className="flex items-center gap-8">
                            ...
                            <div>
                              <h3 className="text-xl font-black uppercase text-[#064e3b] tracking-tighter leading-none mb-2 italic">Portal Vecinos</h3>
                              <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]">Pases Digitales al Instante</p>
                            </div>
                          </div>
                          <div className="w-12 h-12 rounded-full flex items-center justify-center bg-slate-50 group-hover:bg-[#10b981] group-hover:text-white transition-all">
                            <ArrowRight className="w-5 h-5" />
                  ...
                  <div className="fixed bottom-12 text-center w-full z-0 opacity-10">
                    <p className="text-[10px] font-black uppercase tracking-[1.5em] text-[#064e3b]">Santa Ines Intelligence Security 2026</p>
                  </div>
                </div>
              );
            }
